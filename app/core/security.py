...
def _build_token(subject: str, expires: timedelta, token_type: str, extra: dict | None = None) -> tuple[str, str]:
    jti = str(uuid.uuid4())
...
def create_refresh_token(subject: str, extra: dict | None = None) -> tuple[str, str]:
